...
nbsphinx_thumbnails = {
    'examples/lpy_lpymagic': '_static/lpy.png',
    'examples/mtg_analysis': '_static/mtg_analysis.png',
    'examples/mtg_plantframe': '_static/plantframe.png',
    'examples/plantgl_objects': '_static/plantgl_obj.png',
    'examples/pyvis_test': '_static/pyvis.png',
...
pkgver = {}
with open("../src/oawidgets/version.py") as fp:
    exec(fp.read(), pkgver)
...
htmlhelp_basename = "OAWidgets_documentation"
...
man_pages = [(master_doc, "oawidgets", "OAWidgets Documentation", [author], 1)]
